...
/**
 * This class is a filter for selecting only patterns having an integer value equal to a given value.
 *
...
public class FilterEqualInteger extends AbstractFilter {
     ...
     */
    public FilterEqualInteger(int value, String columnName, int columnID) {
