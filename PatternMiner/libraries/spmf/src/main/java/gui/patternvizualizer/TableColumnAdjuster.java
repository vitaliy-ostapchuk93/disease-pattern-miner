 ...
 *
 *  This code was obtained from: http://www.camick.com/java/source/TableColumnAdjuster.java
 *  and was described in a blog post on that website, and is not licensed.
 *
 *  @author Rob Camick
 */
