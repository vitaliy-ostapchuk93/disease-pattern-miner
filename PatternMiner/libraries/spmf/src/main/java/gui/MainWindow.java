...
import algorithmmanager.descriptions.DescriptionAlgoClusterViewer;
import algorithms.timeseries.TimeSeries;
import algorithms.timeseries.reader_writer.AlgoTimeSeriesReader;
import gui.patternvizualizer.PatternVizualizer;
...
public class MainWindow extends JFrame implements ThreadCompleteListener, UncaughtExceptionHandler {
     ...
     * @throws Exception
     */
    public MainWindow(boolean showTools, boolean showAlgorithms) throws Exception {
