...
import algorithms.sequentialpatterns.gsp_AGP.AlgoGSP;
import algorithms.sequentialpatterns.gsp_AGP.items.SequenceDatabase;
import algorithms.sequentialpatterns.gsp_AGP.items.creators.AbstractionCreator;
import algorithms.sequentialpatterns.gsp_AGP.items.creators.AbstractionCreator_Qualitative;
...
/**
 * This class describes the GSP algorithm parameters. It is designed to be used by the graphical and command line interface.
 * 
 * @see AlgoGSP
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoGSP extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoGSP(){
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/GSP.php";
	}
