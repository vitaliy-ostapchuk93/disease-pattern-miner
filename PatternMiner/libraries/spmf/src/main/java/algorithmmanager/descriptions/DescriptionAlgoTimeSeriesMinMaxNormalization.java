...
import algorithms.timeseries.normalization.AlgoMinMaxNormalization;
...
/**
 * This class describes the algorithm to calculate the min max normalization of a time series
 * 
 * @see AlgoMinMaxNormalization
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoTimeSeriesMinMaxNormalization extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoTimeSeriesMinMaxNormalization(){
	}
