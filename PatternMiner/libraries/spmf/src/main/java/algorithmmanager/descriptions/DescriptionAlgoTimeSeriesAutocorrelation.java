...
import algorithms.timeseries.autocorrelation.AlgoLagAutoCorrelation;
 ...
 * 
 * @see AlgoLagAutoCorrelation
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoTimeSeriesAutocorrelation extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoTimeSeriesAutocorrelation(){
	}

	@Override
	public String getName() {
		return "Calculate_autocorrelation_of_time_series";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/TimeSeriesAutocorellation.php";
	}
...
//		Charset charset = PreferencesManager.getInstance().getPreferedCharset();
		...
		for(TimeSeries timeSeries : multipleTimeSeries){
			...
			TimeSeries result = algorithm.runAlgorithm(timeSeries, maxlag);
