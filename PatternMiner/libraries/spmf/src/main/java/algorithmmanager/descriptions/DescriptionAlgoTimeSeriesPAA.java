...
import algorithms.timeseries.paa.AlgoPiecewiseAggregateApproximation;
...
/**
 * This class describes the algorithm to calculate the piecewise aggregate approximation of a time series
 * 
 * @see @AlgoPiecewiseAggregateApproximation
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoTimeSeriesPAA extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoTimeSeriesPAA(){
	}
