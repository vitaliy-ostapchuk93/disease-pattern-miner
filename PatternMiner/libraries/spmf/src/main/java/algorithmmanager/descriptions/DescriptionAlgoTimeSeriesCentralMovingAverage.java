...
import algorithms.timeseries.movingaverage.AlgoCentralMovingAverage;
 ...
 * 
 * @see AlgoCentralMovingAverage
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoTimeSeriesCentralMovingAverage extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoTimeSeriesCentralMovingAverage(){
	}

	@Override
	public String getName() {
		return "Calculate_central_moving_average_of_time_series";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/TimeSeriesCentralMovingAverage.php";
	}
