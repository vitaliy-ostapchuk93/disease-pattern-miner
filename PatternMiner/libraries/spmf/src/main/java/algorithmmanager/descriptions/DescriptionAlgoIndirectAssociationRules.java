...
import algorithms.associationrules.Indirect.AlgoINDIRECT;
...
/**
 * This class describes parameters of the algorithm for generating indirect association rules. 
 * It is designed to be used by the graphical and command line interface.
 * 
 * @see AlgoINDIRECT
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoIndirectAssociationRules extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoIndirectAssociationRules(){
	}
	...
	public DescriptionOfParameter[] getParametersDescription() {
		...
		parameters[1] = new DescriptionOfParameter("TS", "(e.g. 0.5 or 50%)", Double.class, false);
		parameters[2] = new DescriptionOfParameter("Minconf (%)", "(e.g. 0.1 or 10%)", Double.class, false);
		return parameters;
	}
