...
import algorithms.timeseries.differencing.AlgoFirstOrderDifferencing;
 ...
 * 
 * @see AlgoFirstOrderDifferencing
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoTimeSeriesFirstOrderDifferencing extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoTimeSeriesFirstOrderDifferencing(){
	}

	@Override
	public String getName() {
		return "Calculate_first_order_differencing_of_time_series";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/TimeSeriesFirstOrderDifferencing.php";
	}
