...
/**
 * This class describes the CloSpan algorithm parameters. It is designed to be used by the graphical and command line interface.
 * 
 * @see AlgoCloSpan
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoCloSpan extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoCloSpan(){
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/CloSpan.php";
	}
