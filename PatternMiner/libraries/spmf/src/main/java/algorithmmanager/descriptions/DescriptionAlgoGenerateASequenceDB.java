...
import tools.dataset_generator.SequenceDatabaseGenerator;
...
/**
 * This class describes the algorithm to generate a sequence database. It is designed to be used by the graphical and command line interface.
 * 
 * @see SequenceDatabaseGenerator
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoGenerateASequenceDB extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoGenerateASequenceDB(){
	}

	@Override
	public String getName() {
		return "Generate_a_sequence_database";
	}
