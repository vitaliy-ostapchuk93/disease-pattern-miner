...
import algorithms.timeseries.standardization.AlgoStandardization;
...
/**
 * This class describes the algorithm to calculate the standardization of a time series
 * 
 * @see AlgoCumulativeMovingAverage
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoTimeSeriesStandardization extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoTimeSeriesStandardization(){
	}

	@Override
	public String getName() {
		return "Calculate_standardization_of_time_series";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/TimeSeriesStandardization.php";
	}
...
//		Charset charset = PreferencesManager.getInstance().getPreferedCharset();
		...
		// (2) Calculate the transformation of each time series
