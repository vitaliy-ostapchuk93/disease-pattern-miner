package algorithms.timeseries.differencing;
...
/**
 * An algorithm to calculate the first order differencing of a time series.
...
public class AlgoFirstOrderDifferencing {
    ...
    /**
     * Generate the first order differencing of a time series containing at least two data points.
     *
     * @param timeSeries a time series
     * @return the first order differencing of the time series (a time series)
    ...
    /**
     * Generate the first order differencing of a time series
     *
