package algorithms.sequenceprediction.ipredict.database;
...
public class DatabaseHelper {
    ...
    //Data sets
    public enum Format {
        BMS, KOSARAK, FIFA, MSNBC, SIGN, CANADARM1, CANADARM2, SNAKE, BIBLE_CHAR, BIBLE_WORD, KORAN_WORD, LEVIATHAN_WORD, CUSTOM
    }
