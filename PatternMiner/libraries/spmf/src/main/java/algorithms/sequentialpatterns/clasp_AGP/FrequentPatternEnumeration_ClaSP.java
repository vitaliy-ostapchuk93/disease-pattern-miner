package algorithms.sequentialpatterns.clasp_AGP;
...
import algorithms.sequentialpatterns.clasp_AGP.savers.Saver;
...
public class FrequentPatternEnumeration_ClaSP {
     ...
     *
     * @param projection IdList of the prefix to consider
