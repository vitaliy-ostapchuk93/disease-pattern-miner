...
public class FrequentPatternEnumerationFacade implements Callable<Void> {
     ...
     *
     * @param frequentPatternEnumeration the FrequentPatternEnumeration object through which we search
     *                                   for the patterns.
     ...
     *                                   we find.
     * @param keepPatterns               Flag indicating if we want to keep the different patterns that
     *                                   we find.
     * @param verbose                    Flag for debugging purposes.
     * @param saver                      Object that is in charge of saving the output either in a file
