...
//	        		System.out.println(" " + pat.prefix  + "    sup: " + pat.getSupport());
     ...
     * @param minsupRel the minimum support as a relative value
     */
    private void vgen(String input, double minsupRel) {
...
//									if (itemI != itemJ){
     ...
     */
    void dfsPruning(PrefixVGEN prefix, Bitmap prefixBitmap, List<Integer> sn, List<Integer> in, int hasToBeGreaterThanForIStep, int m, Integer lastAppendedItem) {
