package algorithms.sequentialpatterns.fournier2008_seqdim;
...
import algorithms.sequentialpatterns.fournier2008_seqdim.kmeans_for_fournier08.AlgoKMeansWithSupport;
import algorithms.sequentialpatterns.fournier2008_seqdim.kmeans_for_fournier08.Cluster;
...
public class AlgoFournierViger08 extends AbstractAlgoPrefixSpan {
    ...
    private final static Logger LOGGER = Logger.getLogger(AlgoFournierViger08.class.getName());
    ...
    public void runAlgorithm(SequenceDatabase database, String outputFilePath) throws IOException {
        LOGGER.info("Running AlgoFournierViger08.");
    ...
    private void isdb(SequenceDatabase originalDatabase) throws IOException {
        ...
        for (Sequence sequence : originalDatabase.getSequences()) {
            ...
            LOGGER.info("Clone the database with pseudo sequences.");
...
//		System.out.println("NO PRUNING SHOULD BE DONE");
     ...
     *
     * @param contexte the current sequence database
    ...
    private Map<ItemSimple, Set<Integer>> findSequencesContainingItems(SequenceDatabase contexte) {
        LOGGER.info("Looking for sequences containing items.");
