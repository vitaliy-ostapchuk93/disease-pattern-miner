package algorithms.sequentialpatterns.clofast.model.tree;

import algorithms.sequentialpatterns.clofast.AlgoCloFast;
import algorithms.sequentialpatterns.clofast.model.Itemset;
...
public class ClosedItemsetNode implements Comparable<ClosedItemsetNode> {
     ...
     * @param itemset
     * @param position
     * @param sil      by default it has toCheck as type
     */
    ...
    public boolean equals(Object o) {
        ...
        return itemset != null ? itemset.equals(that.itemset) : that.itemset == null;
    }
