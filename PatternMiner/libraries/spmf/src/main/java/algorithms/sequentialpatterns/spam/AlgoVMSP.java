...
//        }
     ...
     * @param minsupRel the minimum support as a relative value
     */
    private void vmsp(String input, double minsupRel) {
...
//            if(!isSubsumedAndNonClosed) {
     ...
     */
    boolean dfsPruning(PrefixVMSP prefix, Bitmap prefixBitmap, List<Integer> sn, List<Integer> in, int hasToBeGreaterThanForIStep, int m, Integer lastAppendedItem) {
