package algorithms.sequentialpatterns.clospan_AGP.items.creators;

import algorithms.sequentialpatterns.clospan_AGP.items.Item;
import algorithms.sequentialpatterns.clospan_AGP.items.Pair;
import algorithms.sequentialpatterns.clospan_AGP.items.PseudoSequence;
import algorithms.sequentialpatterns.clospan_AGP.items.Sequence;
import algorithms.sequentialpatterns.clospan_AGP.items.abstractions.Abstraction_Generic;
