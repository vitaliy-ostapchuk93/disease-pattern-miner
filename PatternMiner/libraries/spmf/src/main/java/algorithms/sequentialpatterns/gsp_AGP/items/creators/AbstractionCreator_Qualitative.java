 ...
 */
package algorithms.sequentialpatterns.gsp_AGP.items.creators;


import algorithms.sequentialpatterns.gsp_AGP.items.CandidateInSequenceFinder;
import algorithms.sequentialpatterns.gsp_AGP.items.Item;
import algorithms.sequentialpatterns.gsp_AGP.items.Itemset;
import algorithms.sequentialpatterns.gsp_AGP.items.Sequence;
import algorithms.sequentialpatterns.gsp_AGP.items.abstractions.Abstraction_Generic;
import algorithms.sequentialpatterns.gsp_AGP.items.abstractions.Abstraction_Qualitative;
import algorithms.sequentialpatterns.gsp_AGP.items.abstractions.ItemAbstractionPair;
import algorithms.sequentialpatterns.gsp_AGP.items.patterns.Pattern;
import algorithms.sequentialpatterns.gsp_AGP.items.patterns.PatternCreator;
