package algorithms.frequentpatterns.HUIM_BPSO_tree;
...
//						+ huiSets.size());
     ...
     *
     * @param pattern the transaction in database need to judge
     */
     ...
     *
     * @param htwuiList the list of items which has higher twu value than minUtil
...
//			System.out.print(System.lineSeparator() + maximalPatterns.get(i) + ":");
     ...
     *
     * @param tempParticle the particle need to update
     * @param i            tempParticle is the i-th of population
     * @return the updated particle
     */
