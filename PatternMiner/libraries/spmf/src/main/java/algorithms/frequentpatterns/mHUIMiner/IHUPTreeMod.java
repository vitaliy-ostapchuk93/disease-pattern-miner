package algorithms.frequentpatterns.mHUIMiner;
...
public class IHUPTreeMod {
     ...
     *
     * @param transaction reorganized transaction that contains Item objects
     ...
     * @param itemID           the item in the new node
     * @return the new node
     */
