package algorithms.frequentpatterns.uphist;
...
public class Hist {
     ...
     *
     * @param interU interU is the internal utility of the transaction to be added
     */
     ...
     *
     * @param supp supp specifies number of transactions
     * @return miniumum internal utility
     */
     ...
     *
     * @param supp supp specifies number of transactions
     * @return maximum internal utility
     */
     ...
     *
     * @param l     internal utility
     * @param value number of transactions
     */
