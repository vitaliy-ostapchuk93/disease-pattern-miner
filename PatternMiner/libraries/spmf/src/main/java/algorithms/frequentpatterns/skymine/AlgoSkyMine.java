package algorithms.frequentpatterns.skymine;
...
public class AlgoSkyMine {
     ...
     *
     * @param transactionFile               path to an input file containing transactions with quantities
     * @param utilityTableFile              path to an input file containing a utility table indicating the internal utility of each item
     * @param outputFilePath                path for writing the output file (if null the result is kept in memory and not saved to file)
     ...
     * @param items prefix of tree till root node
     */
     ...
     *
     * @param countArray The 2-D array returned by the <TT>countSingles</TT> method.
     */
