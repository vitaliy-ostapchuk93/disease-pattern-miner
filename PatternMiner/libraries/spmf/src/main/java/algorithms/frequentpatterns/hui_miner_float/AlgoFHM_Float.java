package algorithms.frequentpatterns.hui_miner_float;
...
//					int remain = remainingUtility; // FOR OPTIMIZATION
                    ...
                    Map<Integer, Float> mapFMAPItem = mapFMAP.get(pair.item);
                    if (mapFMAPItem == null) {
    ...
    private void fhm(int[] prefix,
                     int prefixLength, UtilityList pUL, List<UtilityList> ULs, float minUtility)
            throws IOException {
    ...
    public void printStats() throws IOException {
        ...
        if (DEBUG) {
            ...
            for (Entry<Integer, Map<Integer, Float>> entry : mapFMAP.entrySet()) {
