package algorithms.frequentpatterns.uapriori;
...
public class ItemsetsUApriori {
    ...
    private final List<List<ItemsetUApriori>> levels = new ArrayList<List<ItemsetUApriori>>();  // itemset class� par taille
