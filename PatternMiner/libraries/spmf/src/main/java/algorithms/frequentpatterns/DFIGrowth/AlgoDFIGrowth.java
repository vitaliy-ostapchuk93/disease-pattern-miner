package algorithms.frequentpatterns.DFIGrowth;
...
/**
 * Implementation of the DFI-Growth algorithm.
 * <p>
 * DFIGrowth is an algorithm for deriving frequent itemsets from frequent closed itemsets by pattern growth.
 * It was proposed by JianTao Huang, YiPei Lai, GuanJhong Su, ChengWei Wu*(2018).
 * <br/><br/>
 * <p>
 * See this article for details about this algorithm:
 * <br/><br/>
 * <p>
 * JianTao Huang, YiPei Lai, GuanJhong Su, ChengWei Wu*.  An efficient method for deriving
 * frequent itemsets by pattern growth. Submitted to The Conference on Technologies and Applications
 * of Artificial Intelligence, 2018
 * <br/><br/>
 *
 * @author Cheng-Wei Wu et al., 2018
 */
public class AlgoDFIGrowth {
    ...
    static void MemoryUsage() {
        current_memory = (double) (Runtime.getRuntime().totalMemory() / 1024) / 1024 -
     ...
     */
    public static ArrayList<ArrayList<String>> changeDatabase(ArrayList<ArrayList<String>> predata, ArrayList<ArrayList<String>> frequent) {
     ...
     */
    public static void createFPT(ArrayList<LinkNode> newheaderTable, ArrayList<ArrayList<String>> datainfo) {
     ...
     */
    public static void DFIgrowthReady(ArrayList<LinkNode> linknode) {
        data = null;
     ...
     */
    public static void DFIgrowth(String strname, int hcount, ArrayList<ArrayList<String>> list) {
