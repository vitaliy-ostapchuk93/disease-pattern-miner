 ...
 * <p>
 * The IHUP algorithm was proposed in this paper: <\br><\br>
 * <p>
 ...
 * in Incremental Databases. IEEE Trans. Knowl. Data Eng. 21(12): 1708-1721 (2009)<\br><\br>
 * <p>
...
public class AlgoIHUP {
    ...
    public void runAlgorithm(String input, String output, int minUtility)
        ...
        // ******************************************
        // second database scan  generate revised transaction and global IHUP-Tree

        try {
            IHUPTree tree = new IHUPTree();
            ...
            ihup(tree, minUtility, new int[0]);
    ...
    private void ihup(IHUPTree tree, int minUtility, int[] prefix) throws IOException {
        ...
        for (int i = tree.headerList.size() - 1; i >= 0; i--) {
            ...
            IHUPTree localTree = createLocalTree(minUtility, tree, item);
...
//			int itemCPB = pathCPB.itemID;
            ...
            if (pathCPBUtility >= minUtility) {
                ...
                if (localTree.headerList.size() > 0) {
                    ...
                    ihup(localTree, minUtility, newPrefix);
                }
            }
        }
    }

    private IHUPTree createLocalTree(int minUtility, IHUPTree tree, Integer item) {
        ...
        IHUPTree localTree = new IHUPTree();
    ...
    public void printStats() {
        System.out.println("=============  IHUP ALGORITHM - STATS =============");
