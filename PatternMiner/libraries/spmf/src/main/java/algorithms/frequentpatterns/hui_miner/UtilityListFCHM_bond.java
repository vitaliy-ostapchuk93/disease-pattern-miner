...
/**
 * This class represents a UtilityList as used by the FCHM_bond algorithm.
 *
 * @author Philippe Fournier-Viger
 * @see AlgoHUIMiner
 * @see Element
 */
class UtilityListFCHM_bond extends UtilityList {

    /**
     * The disjunctive bit vector
     */
     ...
     */
    public UtilityListFCHM_bond(int item, BitSetSupport bitsetDisjunctiveTIDs) {
        super(item);
