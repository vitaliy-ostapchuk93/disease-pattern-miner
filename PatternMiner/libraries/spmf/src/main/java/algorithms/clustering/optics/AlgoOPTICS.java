package algorithms.clustering.optics;
...
public class AlgoOPTICS {
     ...
     *
     * @param inputFile  an input file path containing a list of vectors of double
     *                   values
     * @param minPts     the minimum number of points (see DBScan article)
     * @param epsilon    the epsilon distance (see DBScan article)
     * @param seaparator the string that is used to separate double values on each line
     ...
     *
     * @param object      the current point
     * @param orderedFile the current order of points generated by OPTICS
     ...
     *
     * @param neighbors    the neighbors of the current object
     * @param centerObject the current object
     * @param orderSeeds   the orderSeeds structure
     * @param epsilon      the epsilon parameter
     * @param minPts       the minPts parameter
     */
