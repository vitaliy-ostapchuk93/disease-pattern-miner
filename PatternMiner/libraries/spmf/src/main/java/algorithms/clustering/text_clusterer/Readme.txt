...
1. Load the input fileOfResult
2. remove the stopwords
3. stem the words
4. Calculate tf*idf count for each record in the input fileOfResult.
...
9. Write the final output i.e,; final sets of clusters to the output fileOfResult.
