...
public class Select {
	...
	/**
	 * Method to select the ith smallest integer of a sub-array in average linear time.
	 * Based on the Randomized-Select algorithm in "Introduction to algorithms" book by Cormen et al. (2001).
	 * @param a   array of integers
	 * @param i  the i-th value
	 * @param p  the first position of the subarray
	 * @param r  the last position of the subarray
	 * @return the element of "a" that is larger than i elements.
	 */
	// ((see the book for details about the algorithm)
	public static int randomizedSelect(int[] a, int i, int p, int r) {
//		int p = 0;
//		int r = a.length-1;
