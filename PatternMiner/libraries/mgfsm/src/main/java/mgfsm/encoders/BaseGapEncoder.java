...
public abstract class BaseGapEncoder {
     ...
     *
     * @param transaction    long input transaction s
     * @param minPivotOffset the smallest offset of a pivot item -- default value (0)
     * @param maxPivotOffset the largest offset of a pivot item -- default value
     *                       (transaction.length - 1)
     * @param beginItem      items in [beginItem,endItem] are pivot items
     * @param endItem        items > endItem are irrelevant (i.e., treated as gaps)
     * @throws IOException
     */
     ...
     * to the right.
     *
     * @param pos        the position of the current item in the sequence
     * @param pdist      the distance of the current item from the last pivot (counting
     *                   gaps, too); ignored if isPivot==true
     * @param isPivot    whether or not the current item is a pivot
     * @param isRelevant whether or not the current item is a relevant item
     * @param reset      whether previous_ and last_ should be reset
     * @param hops       the hops array to update
     */
