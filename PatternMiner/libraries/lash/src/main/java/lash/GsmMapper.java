...
import lash.encoders.SimpleGapEncoder;
import lash.encoders.SplitGapEncoder;
import org.apache.hadoop.io.BytesWritable;
import org.apache.hadoop.io.IntWritable;
import org.apache.hadoop.io.LongWritable;
import org.apache.hadoop.io.WritableUtils;
import org.apache.hadoop.mapreduce.Mapper;
import taxonomy.NytTaxonomy;
...
public class GsmMapper extends Mapper<LongWritable, IntArrayWritable, BytesWritable, IntWritable> {
     ...
     * encoding, call
     * {@link #emit(int, Context)} to output
     * the result.
     *
     ...
     * @param maxOffset   the maximum offset of a pivot -- default value (transaction.length
     *                    - 1)
