...
public class GsmDriver {
        ...
        try {
            ...
            if (cmd.hasOption("m")) {
                ...
                if (cmd.getOptionValue("m").equals("s")) {
                    config.setMode(GsmConfig.Mode.SEQUENTIAL);
                } else if (cmd.getOptionValue("m").equals("d")) {
                    config.setMode(GsmConfig.Mode.DISTRIBUTED);
                } else {
            ...
            // number of reducers
            if (config.getMode() == GsmConfig.Mode.DISTRIBUTED) {
                if (cmd.hasOption("n")) {
    ...
    private void run() throws Exception {
        if (config.getMode() == GsmConfig.Mode.SEQUENTIAL) {
